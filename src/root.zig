...
pub const RealtimeHighlighter = @import("editor/repl.zig").RealtimeHighlighter;
pub const HighlightSpan = @import("editor/repl.zig").HighlightSpan;
pub const CommandValidator = @import("editor/validation.zig").CommandValidator;
pub const ValidationResult = @import("editor/validation.zig").ValidationResult;
pub const ValidationType = @import("editor/validation.zig").ValidationType;
pub const validateCommands = @import("editor/validation.zig").validateCommands;
pub const isValidCommand = @import("editor/validation.zig").isValidCommand;
pub const CompletionContext = @import("editor/completion.zig").CompletionContext;
pub const CompletionInfo = @import("editor/completion.zig").CompletionInfo;
pub const getCompletionContext = @import("editor/completion.zig").getCompletionContext;
